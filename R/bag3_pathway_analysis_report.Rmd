...
```{r}
gprofiler_spec <- gost(
  co_ip_genes_spec$Genes, organism = "rnorvegicus", ordered_query = TRUE, sources = gprofiler_sources)
gostplot(gprofiler_spec)
```

```{r, fig.width = 11, fig.height = 86}
...
```{r}
gprofiler_abun <- gost(
  co_ip_genes_abun$Genes, organism = "rnorvegicus", ordered_query = TRUE, sources = gprofiler_sources)
gostplot(gprofiler_abun)
```

```{r, fig.width = 11, fig.height = 85.5}
